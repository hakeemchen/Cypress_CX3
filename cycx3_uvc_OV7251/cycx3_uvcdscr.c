...
const uint8_t CyCx3USBSSConfigDscr[] =
{
...
#else    
	0x28,0x0A,0x00, 				   /* exposure supported */
#endif
    ...
    0x00, 0x00, 0x00,                   /* No controls supported */
#else
    0x00, 0x02, 0x00,                   /* No controls supported */
#endif
    ...
    0xFF, 0xFF, 0xFF, 0xFF,      // refer : https://msdn.microsoft.com/en-us/library/windows/desktop/dd757532(v=vs.85).aspx
    0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF,
	...
	//  refer : https://msdn.microsoft.com/en-us/library/windows/desktop/dd757532(v=vs.85).aspx
    ...
    //    not use      /* Class specific Uncompressed VS Frame Descriptor 1 - 1080p@30fps */
    /* Class specific Uncompressed VS Frame Descriptor 1 - VGA_RAW10 */
	...
	// 30frame
	0x15,0x16,0x05,0x00,             /* Desired frame interval in 100ns(uint) = (1/30)x10^7 333333=33.3333ms*/
    0x01,                               /* Frame interval type : No of discrete intervals */
    ...
    0x15, 0x16, 0x05, 0x00,             /* Frame interval 3: Same as Default frame interval */
#else
	/* Class specific Uncompressed VS Frame Descriptor 1 - VGA_RAW10 : 30 frame  */
	0x1E,								/* Descriptor size */
	CX3_CS_INTRFC_DESCR,				/* Descriptor type*/
...
const uint8_t CyCx3USBHSConfigDscr[] =
{
    ...
    0x00,                               /* duplication of the video stream restriction: 0 - no restriction */
#else
   /* GUID, globally unique identifier used to identify streaming-encoding format: RAW10  */
   0X55,0X59,0X56,0X59,
   0X00,0X00,0X10,0X00,
   0X80,0X00,0X00,0XAA,
   0X00,0X38,0X9B,0X71,
/*MEDIASUBTYPE_YVYU  GUID: 55595659-0000-0010-8000-00AA00389B71 */
   0x10,							   /* Number of bits per pixel: 16*/
...
/* UVC Probe Control Setting - VGA_RAW10*/
...
uint8_t const glVga30ProbeCtrl_HS[CX3_APP_MAX_PROBE_SETTING] = {
    ...
    0x01,                               /* Use 1st Video frame index */
//    0x15, 0x16, 0x05, 0x00,             /* Desired frame interval in 100ns = (1/60)x10^7 */
		0x26, 0x25, 0x0a, 0x00, 			/* Desired frame interval in  10Hz  */
